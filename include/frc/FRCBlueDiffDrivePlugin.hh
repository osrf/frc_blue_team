...
namespace gazebo
{
  /// \class FRCBlueDiffDrivePlugin FRCBlueDiffDrivePlugin.hh
  /// \brief ToDo.
  class GAZEBO_VISIBLE FRCBlueDiffDrivePlugin : public ModelPlugin
  {
    /// \brief Constructor.
    public: FRCBlueDiffDrivePlugin() = default;

    /// \brief Destructor.
    public: ~FRCBlueDiffDrivePlugin();
